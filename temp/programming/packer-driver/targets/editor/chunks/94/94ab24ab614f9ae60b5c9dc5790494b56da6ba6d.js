    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Label), _dec(_class = (_class2 = class GameManager extends Component {
        ...
        goNextPlatform() {
          ...
          const bridgeActualLength = this.currentBridge.getComponent(UITransform).contentSize.height * this.currentBridge.scale.y; // console.log(`Current platform position: ${currentPlatformPos.x}`);
        ...
        generateInitialPlatforms() {
          ...
          const sprite = platformInstance.getComponent(Sprite);
